...
export const PAYMENT_STATUS_LABELS: Record<PaymentStatus, string> = { PENDING: "Ödeme Bekleniyor", AUTHORIZED: "Ödeme Onaylandı", PAID: "Ödendi", FAILED: "Ödeme Başarısız", EXPIRED: "Ödeme Süresi Doldu", CANCELLED: "Ödeme İptal Edildi", PARTIALLY_REFUNDED: "Kısmi İade", REFUNDED: "İade Edildi", REFUND_PENDING: "İade Bekleniyor", PARTIAL_REFUND_PENDING: "Kısmi İade Bekleniyor" };
