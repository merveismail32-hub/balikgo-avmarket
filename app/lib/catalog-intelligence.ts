...
export type CatalogMatchReason = "GTIN_EXACT" | "SELLER_SKU_EXACT" | "NO_CANDIDATE" | "TEXT_CANDIDATE" | "MULTIPLE_TEXT_CANDIDATES" | "INVALID_GTIN" | "SKU_GTIN_CONFLICT" | "GTIN_BRAND_CONFLICT" | "GTIN_MODEL_CONFLICT";
...
export type SellerSkuOffer = { id: string; catalogProductId: string; sellerSku: string | null };
