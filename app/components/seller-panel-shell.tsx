...
export function SellerPanelShell({ title, description, children, storeName }: { title: string; description: string; children: ReactNode; storeName?: string }) {
  return (
    <main className="min-h-screen bg-slate-50 text-slate-900">
      ...
      <div className="mx-auto grid min-w-0 max-w-[1440px] lg:grid-cols-[250px_1fr]">
        <aside className="min-w-0 overflow-hidden border-b bg-slate-950 p-4 text-white lg:min-h-[calc(100vh-73px)] lg:border-b-0 lg:border-r">
          <SellerOrderAlerts />
