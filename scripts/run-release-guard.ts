...
const gates: CommandGate[] = [
  ...
  command("installment-policy", "PAYMENT_SAFETY", nodeTs("scripts/verify-installment-policy.ts"), 30_000),
  command("effective-installment-resolution", "PAYMENT_SAFETY", nodeTs("scripts/verify-effective-installment-resolution.ts"), 30_000),
  command("checkout-installment-adoption", "PAYMENT_SAFETY", nodeTs("scripts/verify-checkout-installment-adoption.ts"), 30_000),
  command("provider-installment-consistency", "PAYMENT_SAFETY", nodeTs("scripts/verify-provider-installment-consistency.ts"), 30_000),
